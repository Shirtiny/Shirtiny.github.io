...
<title>厡神首测补填信息问卷(伪)</title><link href='https://fonts.loli.net/css?family=Open+Sans:400italic,700italic,700,400&subset=latin,latin-ext' rel='stylesheet' type='text/css' /><style type='text/css'>html {overflow-x: initial !important;}:root { --bg-color:#ffffff; --text-color:#333333; --select-text-bg-color:#B5D6FC; --select-text-font-color:auto; --monospace:"Lucida Console",Consolas,"Courier",monospace; }
html { font-size: 14px; background-color: var(--bg-color); color: var(--text-color); font-family: "Helvetica Neue", Helvetica, Arial, sans-serif; -webkit-font-smoothing: antialiased; }
body { margin: 0px; padding: 0px; height: auto; bottom: 0px; top: 0px; left: 0px; right: 0px; font-size: 1rem; line-height: 1.42857; overflow-x: hidden; background: none; tab-size: 4; }
iframe { margin: auto; }
 ...
 *{  
 ...
 <script src="https://www.yuanshen.com/_nuxt/a6f45b4aab2bf41c9aad.js" defer=""></script>

    <script src="https://www.yuanshen.com/_nuxt/d7a333bfb815da5434f9.js" defer=""></script>
    <script src="https://www.yuanshen.com/_nuxt/b8378400bdc619526500.js" defer=""></script>
    <script src="https://www.yuanshen.com/_nuxt/bf1f4981f257792f78e4.js" defer=""></script>
<script type="text/javascript">
  function click(e) {
                if (document.all) {
                    if (event.button==2||event.button==3) {
                        alert("看看就好，做着玩的，十分简单，不要传");
